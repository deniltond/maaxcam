...
class BRZipCodeField(RegexField):
    ...
    default_error_messages = {
        'invalid': _('Informe o cep no formato XXXXX-XXX.'),
    }

#     def clean(self, value):
#         super(BRZipCodeField, self).clean(value)
...
class BRPhoneNumberField(Field):
    ...
    """
    default_error_messages = {
        'invalid': _(('Telefone deve estar nos formatos '
...
class BRCPFField(CharField):
    ...
    default_error_messages = {
        ...
        'max_digits': _("Requer ao menos 11 dígitos."),
        'digits_only': _("Somente números."),
    }
...
class BRCNPJField(Field):
    ...
    default_error_messages = {
        ...
        'digits_only': _("Somente números."),
        'max_digits': _("Requer no mínimo 14 digitos"),
    }
