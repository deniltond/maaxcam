...
#         verbose_name_plural = _("signup codes")
        verbose_name = u"Código de Cadastro"
        verbose_name_plural = u"Códigos de Cadastro"
...
#         verbose_name_plural = _("account deletions")
        verbose_name = u"Conta excluída"
        verbose_name_plural = u"Contas excluídas"
